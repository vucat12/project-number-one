...
function ViewChartSeller() {
  ...
  useEffect(() => {
    ...
    if (!isTypeChart) getPriceData(valueProvinces);
  }, [isTypeChart]);
  ...
  return (
    <div className="chart-center">
      <div className="dropdown-search padding-left-60 pt-3">
        <Button
          label={isTypeChart ? "Xem biểu đồ giá" : "Xem biểu đồ diện tích"}
          onClick={() => handleChangeChart()}
        />
        <Dropdown
          className="ml-3 Dropdown"
          options={listProvinces}
          onChange={(e) => handleChangeProvince(e.label)}
      ...
      {isTypeChart && (
        <div>
          <div className="card">
            <h4>Biểu đồ tròn diện tích đất cần bán (% m2)</h4>
            <Chart
              width="600px"
              height="600px"
              type="pie"
